...
type NavItem = {
  path: string;
  label: string;
  NavIcon: (p: { width?: string | number; height?: string | number; className?: string }) => React.ReactElement;
};
...
export const Sidebar = () => {
  ...
  return (
    <aside className="bg-sidebar text-slate-200 flex flex-col w-[220px] shrink-0 px-3.5 pt-[18px] pb-4 h-screen sticky top-0">
      <div className="flex items-center gap-3 px-2 pb-4 border-b border-white/[0.06]">
        ...
        <div>
          ...
          <div className="text-[11.5px] text-slate-400 mt-px">Production Manager</div>
        </div>
      </div>
      ...
      <div className="mt-auto pt-3.5 border-t border-white/[0.06]">
        <div className="flex items-center gap-2.5 px-1.5 py-2">
          ...
          <div>
            <div className="text-[12.5px] font-semibold text-slate-200">Jordan Miles</div>
